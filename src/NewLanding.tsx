...
export default function NewLanding() {
  ...
  return (
    <div className="min-h-screen bg-white" dir="rtl">
              ...
              >
                <div className="relative h-full bg-gradient-to-br from-emerald-900 to-emerald-800 rounded-2xl p-8 md:p-10 overflow-hidden hover:shadow-2xl transition-all duration-500 hover:scale-[1.02]">
                  ...
                  <div className="relative z-10 flex flex-col md:flex-row items-center md:items-start gap-6">
                    <div className="w-24 h-24 flex-shrink-0 rounded-2xl bg-[#b89c57] flex items-center justify-center shadow-xl group-hover:rotate-6 transition-transform duration-500">
                    ...
                    <div className="text-center md:text-right flex-1">
                      ...
                      <p className="text-emerald-100 text-lg">
                        יועצים, מאמנים, מעצבים, טכנאים ורופאים.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              >
                <div className="relative h-full bg-[#b89c57] rounded-2xl p-8 overflow-hidden hover:shadow-2xl transition-all duration-500 hover:scale-[1.02]">
                  ...
                  <div className="relative z-10 text-center">
                    ...
                    <h3 className="text-emerald-900 text-2xl mb-3">
                      בעלי עסקים
                    </h3>
                ...
                <div className="relative h-full bg-gradient-to-br from-emerald-900 to-emerald-800 rounded-2xl p-8 md:p-10 overflow-hidden hover:shadow-2xl transition-all duration-500 hover:scale-[1.02]">
                  ...
                  <div className="relative z-10 flex flex-col md:flex-row items-center md:items-start gap-6">
                    ...
                    <div className="text-center md:text-right flex-1">
                      ...
                      <p className="text-emerald-100 text-lg">
                        עסקים שמוכנים להפוך עבודה קשה להכנסה יציבה וצומחת.
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <section className="py-16 md:py-24 bg-gradient-to-b from-emerald-900 via-emerald-800 to-slate-900 relative overflow-hidden">
            ...
            <div className="relative max-w-5xl mx-auto">
              ...
              <div className="space-y-12 md:space-y-16">
                ...
                },
                {
                  ...
                  description: "פיתוח שירותים ומוצרים, תמחור, חבילות/��נדלים, Upsell & Cross-sell.",
                  detail: "",
                  color: "purple",
                  side: "right"
                },
